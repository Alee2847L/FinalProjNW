...
class Carritos extends \Controllers\PublicController
{
    ...
    public function run() :void
    {
        ...
        if (!$this->isPostBack()) {
            ...
            if (!$this->hasErrors) {
                switch ($this->mode){
                case "INS":
                    if (\Dao\Compras\Carrito::insert($this->idDispositivo, $this->nombre, $this->marca, $this->serie, $this->categorias_idCategoria, $this->precioUnitario, $this->stock, $this->urldip)) {
                    ...
                    break;
                case "UPD":
                    if (\Dao\Compras\Carrito::update($this->nombre, $this->marca, $this->serie, $this->categorias_idCategoria, $this->precioUnitario, $this->stock, $this->urldip, $this->idDispositivo)) {
                        \Utilities\Site::redirectToWithMsg(
                            "index.php?page=mnt_dispositivos",
                    ...
                    break;
                case "DEL":
                    if (\Dao\Compras\Carrito::delete($this->idDispositivo)) {
                        \Utilities\Site::redirectToWithMsg(
                            "index.php?page=mnt_dispositivos",
    ...
    {
        $_data = \Dao\Compras\Carrito::getOne($this->idDispositivo);
        if ($_data) {
