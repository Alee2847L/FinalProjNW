...
class Carrito extends \Dao\Table
{
    public static function getAll()
    {
        return self::obtenerRegistros("SELECT * from carrito;", array());
    }
    ...
    {
        $insstr = "insert into carrito (idDispositivo, nombre, marca, serie, categorias_idCategoria, precioUnitario, stock, urldip) values (:idDispositivo, :nombre, :marca, :serie, :categorias_idCategoria, :precioUnitario, :stock, :urldip);";
    ...
    {
        $updsql = "update carrito set nombre = :nombre, marca = :marca, serie = :serie, categorias_idCategoria = :categorias_idCategoria, precioUnitario = :precioUnitario, stock = :stock, urldip = :urldip where idDispositivo =:idDispositivo;";
        return self::executeNonQuery(
            $updsql,
    ...
    {
        $delsql = "delete from carrito where idDispositivo=:idDispositivo;";
        return self::executeNonQuery(
            $delsql,
